...
extern __declspec(dllexport) void SetConversation(char* operationID, char* conversationID, char* draftText);
...
extern __declspec(dllexport) void ChangeInputStates(char* operationID, char* conversationID, _Bool focus);
extern __declspec(dllexport) void HideAllConversations(char* operationID);
extern __declspec(dllexport) void ClearConversationAndDeleteAllMsg(char* operationID, char* conversationID);
extern __declspec(dllexport) void GetInputStates(char* operationID, char* conversationID, char* userID);
...
extern __declspec(dllexport) void SearchConversation(char* operationID, char* searchParam);
...
extern __declspec(dllexport) void UpdateFriends(char* operationID, char* req);
extern __declspec(dllexport) void CreateGroup(char* operationID, char* groupReqInfo);
extern __declspec(dllexport) void JoinGroup(char* operationID, char* groupID, char* reqMsg, int32_t joinSource, char* ex);
...
extern __declspec(dllexport) void getJoinedGroupListPage(char* operationID, int32_t offset, int32_t count);
...
extern __declspec(dllexport) void SubscribeUsersStatus(char* operationID, char* userIDs);
extern __declspec(dllexport) void UnsubscribeUsersStatus(char* operationID, char* userIDs);
extern __declspec(dllexport) void GetSubscribeUsersStatus(char* operationID);
